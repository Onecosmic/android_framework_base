...
//	Slog.i(TAG, "inciando usb service");
...
//            Slog.i(TAG, "Seguimos con el manager mtp puto");
        }
...
//            Slog.i(TAG, "Se creo device Legacy!!");
    }
    ...
    public UsbAccessory getCurrentAccessory() {
        if (mDeviceManager != null) {
    	    Slog.i(TAG, "Estel Current Accessory: " + mDeviceManager.getCurrentAccessory());
